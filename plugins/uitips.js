		...
		UiTips.prototype = {
		  ...
		  exportsModuleApis: function(){
		    ...
		    this.dataset.privateApis[api.privateApi.showUiTips]  = function(data){
		      ...
		      if ( that.context.msg.run(api.privateApi.isSmallWindowMode)) return;
		    ...
		    this.dataset.privateApis[api.privateApi.isUiTipsShowing]  = function(data, options){
		      options.data = !that.dataset.$tips.hasClass(Txplayer.dataset.hideClass);
		    }
