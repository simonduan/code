	...
	/***/ function(module, exports, __webpack_require__) {
		...
		UiBrowserFullScreen.prototype = {
		  ...
		  bindMouseEvent: function(){
		    var that = this;
		    this.dataset.$fakebtn.on('mouseenter', function(){
		      that.dataset.$fakebtn.addClass(Txplayer.dataset.btnHoverClass);
		    }).on('mouseleave', function(){
		      that.dataset.$fakebtn.removeClass(Txplayer.dataset.btnHoverClass);
		    });
		  },
		  ...
		  exportsModuleApis: function(){
		    ...
		    this.dataset.moduleApis[api.publicApi.enterBrowserFullscreen] = function() {
		      ...
		      // 有弹幕的情况
		      if (that.context.superMsg.run(api.privateApi.isShowBulletRegion)){
