	...
	/***/ function(module, exports) {
		...
		HdPlayerHistory.prototype = {
		  init: function(){
		    ...
		    this.dataset.dataKey_historyAdMute = Txplayer.dataset.localStorageKey.adMuteHistory;
		  ...
		  saveAdMuteData: function(isMute){
		    util.setData(this.dataset.dataKey_historyAdMute, isMute);
		  },
		  getAdMuteData: function(){
		    return util.getData(this.dataset.dataKey_historyAdMute);
		  },
		  addEventListener: function(){
		    ...
		    this.dataset.eventsList[util.getUniqueMsgKey(api.eventApi.onSectionPlay)] = function(data, options){
		      if (data && data.playListType!=='film') {
		        var isMute = that.getAdMuteData()==='true';
		        that.context.msg.broadcast(api.privateApi.adMuteStateUpdate, {mute: isMute});
		      }
		    }
		    this.dataset.eventsList[util.getUniqueMsgKey(api.eventApi.onAdMuteChange)] = function(data, options){
		      if (data && data.hasOwnProperty('mute')) {
		        that.saveAdMuteData(data.mute);
		      }
		    }
