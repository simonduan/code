...
*/
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var htmlstr = __webpack_require__(84);
		...
		UiWindowFullScreen.prototype = {
		  ...
		  bindMouseEvent: function(){
		    var that = this;
		    this.dataset.$fullscreenBtn.on('mouseenter', function(){
		      that.dataset.$fullscreenBtn.addClass(Txplayer.dataset.btnHoverClass);
		    }).on('mouseleave', function(){
		      that.dataset.$fullscreenBtn.removeClass(Txplayer.dataset.btnHoverClass);
		    });
		  },
