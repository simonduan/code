...
*/
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		H5PlayerControl.prototype = {
		  ...
		  play: function(options){
		    ...
		    // 切换视频vid
		    if (options.vid && options.vid!==this.dataset.vid) {
		      this.dataset.hasRequestLoadingAdData = false;
		    }
		    // 已经请求过广告，直接播放
		  ...
		  addEventListener: function(){
		    ...
		    this.dataset.eventsList[util.getUniqueMsgKey(api.eventApi.onEndingAdDataReady)] = function(data){
		      if (!data || $.type(data)!=='array' || !data.length) {
		        return;
		      }
		      var adUrls = [];
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var $ = Txplayer.$;
		var util = Txplayer.util;
		var AppHelper = __webpack_require__(25);
